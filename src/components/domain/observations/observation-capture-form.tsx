...
export function ObservationCaptureForm({
  ...
  return (
    <div className="space-y-6 rounded-lg borderborder-border bg-background p-[var(--density-card-padding)]">
      {error && (
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex gap-2">
                <button
                  ...
                  className="rounded-md bg-primary px-3 py-1 text-xs font-medium text-primary-foreground hover:bg-amber-700"
                >
                  Publish Anyway
                </button>
                <button
      ...
      <div>
        ...
        <div className="relative mt-2">
          ...
          {showStudentDropdown && filteredStudents.length > 0 && (
            <div className="absolute z-10 mt-1 max-h-48 w-full overflow-y-auto rounded-lg borderborder-border bg-background shadow-lg">
              {filteredStudents.slice(0, 10).map((student) => (
                ...
                >
                  {student.photoUrl ? (
                    ...
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-muted-foreground">
                      {student.firstName.charAt(0)}
                    </span>
                  )}
                  <span>
        ...
        <div className="relative mt-2">
          ...
          {showOutcomeDropdown &&
            ...
            filteredOutcomes.length === 0 && (
              <div className="absolute z-10 mt-1 w-full rounded-lg borderborder-border bg-background p-3 text-center text-sm text-muted-foreground shadow-lg">
      ...
      <div>
        ...
        <div className="mt-2">
          ...
          <button
            ...
            disabled={isBusy}
            className="inline-flex items-center gap-2 rounded-lg border border-dashed border-gray-300 px-4 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:border-primary hover:bg-amber-50 hover:text-amber-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <svg
              className="h-5 w-5"
              fill="none"
      ...
      <div className="flex items-center gap-3 border-t border-gray-100 pt-4">
        <button
          ...
          disabled={isBusy}
          className="rounded-lg border border-gray-300 px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-background disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        {canPublish && (
          <button
            onClick={() => handleSave(true)}
            disabled={isBusy}
            className="rounded-lg bg-[var(--mastery-mastered)] px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
