  ...
  return (
    <div className="space-y-[var(--density-section-gap)] max-w-[var(--content-narrow-width)]">
      ...
      <section className="rounded-lg border border-border bg-card p-[var(--density-card-padding)]">
        <h2 className="text-lg font-semibold text-foreground">Brand Colour</h2>
        ...
        <div className="mt-4 flex flex-wrap gap-[var(--density-sm)]">
          {huePresets.map((preset) => {
            ...
            return (
              ...
              >
                <div
                  className="h-[var(--density-button-height)] w-10 rounded-full border border-border"
                  style={{
                    background: `hsl(${preset.hue} ${preset.sat}% 50%)`,
                  }}
                />
        ...
        <button
          ...
          className="mt-3 text-sm text-muted-foreground underline decoration-dotted hover:text-foreground"
        >
      ...
      <section className="rounded-lg border border-border bg-card p-[var(--density-card-padding)]">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Controls spacing and sizing across the platform. Users can override
      ...
      {/* ---- Default Theme ---- */}
      <section className="rounded-lg border border-border bg-card p-[var(--density-card-padding)]">
        <h2 className="text-lg font-semibold text-foreground">Default Theme</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          The default appearance for all users. Each user can override this in
