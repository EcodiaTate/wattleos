...
//
// ============================================================
// WattleOS V2 — Sidebar Navigation (DESIGN SYSTEM MIGRATED)
// ============================================================
// MIGRATION CHANGES:
// • bg-white → bg-sidebar-background (dark mode + brand aware)
// • border-gray-200 → border-sidebar-border
// • text-gray-900/700/500/400 → text-sidebar-foreground / text-muted-foreground
// • bg-amber-50/100, text-amber-600/700 → bg-primary/10, text-primary
// • bg-amber-500 (badge) → bg-primary
// • bg-black/50 → bg-[var(--overlay)]
// • bg-gray-200 (avatar) → bg-muted
// • hover:bg-gray-100 → hover:bg-sidebar-accent
// • hover:bg-gray-50 → hover:bg-sidebar-accent
// • w-64 → w-[var(--sidebar-width)]
// • text-sm/xs → text-[var(--text-sm/xs)]
// • Added palette icon for user settings nav
// ============================================================
