// src/app/(app)/[tenant]/pedagogy/content-library/compliance/page.tsx
//
// ============================================================
...
// every EYLF/NQS/QCAA outcome during assessment visits. Making
// this a first-class page rather than a buried report reduces
// stress and preparation time.
// ============================================================
      ...
      {hasEvidence && (
        <div className="divide-y divide-border">
          {outcome.evidence.map((ev) => (
            <EvidenceRow key={ev.id} evidence={ev} tenant={tenant} />
          ))}
        </div>
      )}
    </div>
...
function EvidenceRow({
  ...
  const href = isObservation
    ? `/${tenant}/pedagogy/observations/${evidence.id}`
    : `/${tenant}/pedagogy/mastery`; // Mastery doesn't have individual detail pages
