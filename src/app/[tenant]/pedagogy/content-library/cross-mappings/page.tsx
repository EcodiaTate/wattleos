// src/app/(app)/[tenant]/pedagogy/content-library/cross-mappings/page.tsx
//
// ============================================================
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {getCommonPairs(templates).map(([source, target]) => (
                <Link
                  ...
                  href={`/${tenant}/pedagogy/content-library/cross-mappings?source=${source.id}&target=${target.id}`}
...
function CrossMappingRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr_auto_auto] gap-2 px-4 py-3 items-center hover:bg-muted/10">
      {/* Source */}
      <Link
        href={`/${tenant}/pedagogy/content-library/node/${mapping.source_node.id}`}
      ...
      {/* Target */}
      <Link
        href={`/${tenant}/pedagogy/content-library/node/${mapping.target_node.id}`}
        className="text-sm hover:text-primary transition-colors truncate"
      >
