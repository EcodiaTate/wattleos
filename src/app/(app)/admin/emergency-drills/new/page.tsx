...
export const metadata = { title: "Schedule Drill - WattleOS" };
...
export default async function NewDrillPage() {
  ...
  // Fetch classes and staff in parallel
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <span style={{ color: "var(--foreground)" }}>Schedule New Drill</span>
      </div>
      ...
      <div>
        ...
        >
          Plan and schedule a new emergency drill for your service
        </p>
      </div>
      ...
      >
        <DrillForm classes={classes} staff={staff} />
      </div>
    </div>
  );
}
