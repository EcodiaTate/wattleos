// src/app/(app)/admin/programs/[id]/edit/page.tsx
//
// ============================================================
// WattleOS V2 - Edit Program Page
// ============================================================

export const metadata = { title: "Edit Program - WattleOS" };
  ...
  return (
    <div className="content-narrow animate-fade-in space-y-[var(--density-section-gap)]">
      ...
      <nav className="flex items-center text-sm text-[var(--breadcrumb-fg)] gap-2">
        <Link href="/admin/programs" className="hover:text-[var(--primary)] transition-colors">
          Programs
        </Link>
        <span className="text-[var(--breadcrumb-separator)]">/</span>
        <Link href={`/admin/programs/${id}`} className="hover:text-[var(--primary)] transition-colors">
          {program.name}
        </Link>
        <span className="text-[var(--breadcrumb-separator)]">/</span>
