// src/app/(app)/(app)/pedagogy/content-library/template/[templateId]/page.tsx
//
// ============================================================
...
//
// FIX: Cross-mapping link now uses ?source= instead of ?template=
// to match the cross-mappings page's expected searchParams.
// ============================================================
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          href={`/pedagogy/curriculum?fork=${templateId}`}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <ActionCard
          href="/pedagogy/content-library/materials"
        ...
        {template.is_compliance_framework && (
          <ActionCard
            href={`/pedagogy/content-library/compliance?template=${templateId}`}
            title="Compliance Report"
            description="Generate evidence report for this compliance framework"
            icon={<ShieldIcon />}
          />
        )}
        {/* FIX: Use ?source= to match the cross-mappings page searchParams */}
        <ActionCard
          href={`/pedagogy/content-library/cross-mappings?source=${templateId}`}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {complianceTemplates.map((ct) => (
              <Link
                key={ct.id}
                href={`/pedagogy/content-library/cross-mappings?source=${templateId}&target=${ct.id}`}
