...
**School Identity**: At the top, you see your school's name and logo (or the first letter of the school name if no logo has been set).

**Navigation Items**: The main section with links to each module. Items appear in a logical workflow order: pedagogy tools first (observations, curriculum, mastery), then student management (students, classes), operations (attendance, reports, programs), communications, timesheets, and finally admin tools at the bottom.

**User Profile**: At the bottom, you see your name, email, and role. This section contains the Sign Out button and, if you belong to multiple schools, a Switch School button.

## What Each Role Sees

The sidebar is permission-gated, meaning it only shows items relevant to your role:

**Guides** typically see: Dashboard, Observations, Curriculum, Content Library, Mastery, Students, Classes, Attendance, Reports, Communications, Timesheets, and Settings.

**Parents** see: Dashboard, My Children, Announcements, Messages, and Events. Parents do not see any staff or admin tools.
...
The Communications and Announcements sidebar items show a badge with the count of unread items. This includes unacknowledged announcements and unread messages, combined into a single number. The badge updates each time a page loads.
...
Your collapsed or expanded preference is saved in your browser's local storage, so it persists across page navigations and sessions on the same device. Different devices maintain their own preference.
...
Beyond the sidebar, WattleOS supports keyboard shortcuts for fast navigation:

- **Ctrl/Cmd + K** opens the quick search, letting you find students, pages, or actions by typing
- **Ctrl/Cmd + N** opens the new observation form from any page
- **Ctrl/Cmd + /** opens Ask Wattle, the documentation assistant
- **Escape** closes any open modal, panel, or overlay

These shortcuts work from any page in the application. The quick search is the fastest way to jump to a specific student profile or section without clicking through the sidebar.
